...
observe that the 'mainlobe' of the magnitude spectrum in tmX2 will be much smaller than that in mX1 and 
...
def zpFFTsizeExpt(x, fs):
    ...
    mX1 = dftAnal(xseg, w1, 256)
    mX2 = dftAnal(x, w2, 512)
    mX3 = dftAnal(xseg, w1, 512)
